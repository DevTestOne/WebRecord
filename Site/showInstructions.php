        ...
        <div class="container text-center">
            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1">
                    <h2 class="text-default">Antes de comenzar favor revise que cuenta con el siguiente navegador!</h2><hr>
                    <div class="row text-justify">
                        <div class="col-sm-12">
                           <ul>
						     <li>Navegador Firefox version 23 o posterior</li>
							 <li><a target="_blank" href="https://www.mozilla.org/es-MX/firefox/new/">Descargar aqui</a></li>
							 <li>Una vez instalado, favor de abrir la liga que recibio por correo y podra comenzar la prueba</li>
						   </ul>
						   <BR><BR>
						   <form class='form-horizontal' action="showTest.php" method="POST" role='form'>							
							...
							<input type="hidden" name="scheduleID" id="scheduleID" value="<?php echo $idSchedule ?>">	
							<button class="btn btn-primary btn-lg subscribe-btn" type="submit">Comenzar !</button>
							</form>
                        </div>
                    </div>
                </div>
