	  ...
	  <!-- Left Sidebar End -->
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<a class="btn btn-red-1" onclick="javascript:createUser();">Add User</a>
				</div>
            	<!-- Page Heading End-->				
				...
				<div class="row">
				    <div class="col-md-12">
						<div class="widget">
							...
							<br>
                               <form class='form-horizontal' action="../DMU/ValidateUsers.php" method="POST" role='form'>							
