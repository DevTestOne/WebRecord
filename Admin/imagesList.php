        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-table'></i> Image List</h1>
            		
				<a class="btn btn-red-1" onclick="javascript:addImage();">Add Image</a>
				</div>
            	<!-- Page Heading End-->				
				    ...
				    <div class="col-md-12">
						<div class="widget">
							<div class="widget-header">
								<h2><strong>Employees</strong> whitot a valid status </h2> 
