        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
                  <h1><i class='fa fa-user'></i> Create User</h1>
            	</div>
            	<!-- Page Heading End-->	
					...
					<div class="widget-content padding">
						...
						<form class="form-horizontal" role="form">
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10">
							  <input type="text" class="form-control" id="apellidos" placeholder="Name">
							</div>
						  </div>
						  <div class="form-group">
						  ...
						  <div class="form-group">
							...
							<div class="col-sm-10" id="roles">
								<select class="form-control" id="rol">
								  <option value="0">Select an option</option>
								  <?echo $catalog->getOptions(1);?>
								</select>
							</div>
						  </div>
						  
						  
						  <button type="button" class="btn btn-default" onclick="javascript:saveUser();">Save</button>
