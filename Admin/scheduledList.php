...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Scheduled List | CLP</title>   
        ...
        <div class="content-page">
            ...
            <div class="content">
				...
				<div class="page-heading">
            		<h1><i class='fa fa-table'></i> Scheduled List</h1>
            		
				<a class="btn btn-red-1" onclick="javascript:scheduleTest();">Schedule a test</a>
				</div>
            	<!-- Page Heading End-->				
				    ...
				    <div class="col-md-12">
						<div class="widget">
							<div class="widget-header">
								<h2><strong>Scheduled</strong> test</h2> 
	...
	<script src="assets/js/pages/scheduledList.js"></script>
	</body>
</html>